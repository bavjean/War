...
class Game {
	...
	play() {
		while (playerOne.length > 0 && playerTwo.length > 0 && this.round < 20000) {
		...
		if (this.round >= 20000) console.log("This game may never end... please refresh the page to try again")
